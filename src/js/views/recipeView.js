...
class RecipeView extends View {
    ...
    _errorMessage = 'We could not find that recipe. Please try searching another!';
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener('click', e => {
            ...
            handler(Number(btn.dataset.serving));
        });
    }
    ...
    _generateMarkup() {
        return `
            ...
            <div class="recipe__info">
                ...
                <button data-serving="${this._data.servings - 1}" class="btn--tiny btn--decrease-servings">
                    <svg>
